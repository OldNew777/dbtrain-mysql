...
public:
  ...
  public:
    ...
    Io_statementContext() : antlr4::ParserRuleContext() { }
  ...
  public:
    ...
    Alter_statementContext() : antlr4::ParserRuleContext() { }
  ...
  class  Alter_table_renameContext : public Alter_statementContext {
  public:
    Alter_table_renameContext(Alter_statementContext *ctx);
