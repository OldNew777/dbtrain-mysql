...
-- SELECT * FROM PART WHERE PART.P_NAME >= 'z';

ALTER TABLE PART ADD INDEX(P_PARTKEY);
SELECT * FROM PART WHERE PART.P_PARTKEY IN (23, 34);
SELECT * FROM PART WHERE PART.P_PARTKEY = 23;
SELECT PART.P_PARTKEY, PART.P_BRAND FROM PART WHERE PART.P_PARTKEY = 23;

-- SELECT PART.P_NAME FROM PART WHERE PART.P_NAME >= 'z';
