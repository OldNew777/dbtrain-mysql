...
CREATE TABLE PARTSUPP (
    ...
    FOREIGN KEY FK1 (PS_PARTKEY) REFERENCES PART(P_PARTKEY),
    FOREIGN KEY FK2 (PS_SUPPKEY) REFERENCES SUPPLIER(S_SUPPKEY)
);
...
CREATE TABLE LINEITEM (
    ...
    FOREIGN KEY NB (L_PARTKEY,L_SUPPKEY) REFERENCES PARTSUPP(PS_SUPPKEY,PS_PARTKEY)
);
-- DESC NATION;
-- DESC REGION;
-- DESC SUPPLIER;
